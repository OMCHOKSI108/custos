...
How to deploy Custos to production.
...
**Your app will be at:** `https://custos.onrender.com`
...
**Your app:** `https://custos-production.up.railway.app`
...
2. **Deploy:**
   ```bash
   eb init -p python-3.10 custos
   eb create custos-env
